...
function Activities() {
  return (
    <NoNavbar className='flex w-full justify-center items-center'>
        ...
        <img className='w-[700px]' src="https://www.tourismvaganza.com/wp-content/uploads/2020/01/IMG_20200107_115718.jpg" alt="" />
        ...
        <img className='w-[700px]' src="https://www.bernas.id/wp-content/uploads/2022/06/IMG_202206163_183158220-750x430.png" alt="" />
        ...
        <img className='w-[700px]' src="https://outboundoffroad.com/aeli-luncurkan-program-virtual-experiential-learning-detail-436887" alt="" />
        ...
        <img className='w-[700px]' src="https://venuemagz.com/wp-content/uploads/2021/02/Goa-Lawang-scaled-800x533_c.jpg" alt="" />
